...
def _extract_check_blocks_from_file(file_text):
...
def read_check_blocks(directory):
    ...
    for file_name in file_names:
        ...
        with open(file_full_address, "r", encoding="utf-8") as file:
            file_text = file.read()
            text_num, blocks = _extract_check_blocks_from_file(file_text)
            text_blocks.append(blocks)
    return text_blocks


if __name__=="__main__":
    text_blocks = read_check_blocks("out/text_categories")